    ...
    <>
      ...
      <main className="bg-white min-h-screen w-full mx-auto max-w-[1920px] px-6 sm:px-12 lg:px-24 py-12">
        <section className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-4">NeoZaar Terms of Use</h1>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">2. Use of the Platform</h2>
          <p className="mb-6">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">3. ISV and Partner Submissions</h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">7. Privacy and Data Use</h2>
          <p className="mb-6">
            Please refer to our{" "}
            <a
              href="/privacy-policy"
