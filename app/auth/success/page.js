  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Title */}
        <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-2 sm:mb-4 lg:mb-6">
        ...
        <a
          href="/"
          className="inline-block px-3 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-3 md:py-4 rounded-lg 
            bg-gradient-to-r from-[#F79331] to-[#CB5D18] 
